...
$(".changeTopBarColor").on("click", function () {
  ...
  } else if ($(this).attr("data-color") == "hidden") {
    $(".main-header .navbar-header").addClass("navbar-header-transparent");
    $(".main-header .navbar-header").removeAttr("data-background-color");
  } else {
    $(".main-header .navbar-header").removeClass("navbar-header-transparent");
...
function customCheckColor() {
  ...
  if (logoHeader !== "white") {
    $(".logo-header .navbar-brand").attr("src", baseUrl + "assets/img/kaiadmin/logo_light.png");
	} else {
		$(".logo-header .navbar-brand").attr("src", baseUrl + "assets/img/kaiadmin/logo_dark.png");
  }
}
